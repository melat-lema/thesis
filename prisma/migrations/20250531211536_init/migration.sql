...
-- CreateIndex
CREATE UNIQUE INDEX "StudyMaterial_cId_key" ON "StudyMaterial"("cId");

-- CreateIndex
CREATE INDEX "ChapterNote_courseId_idx" ON "ChapterNote"("courseId");
...
-- CreateIndex
CREATE INDEX "Flashcard_studyMaterialId_idx" ON "Flashcard"("studyMaterialId");
...
-- AddForeignKey
ALTER TABLE "ChapterNote" ADD CONSTRAINT "ChapterNote_courseId_fkey" FOREIGN KEY ("courseId") REFERENCES "StudyMaterial"("cId") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Flashcard" ADD CONSTRAINT "Flashcard_studyMaterialId_fkey" FOREIGN KEY ("studyMaterialId") REFERENCES "StudyMaterial"("cId") ON DELETE CASCADE ON UPDATE CASCADE;
